...
export default function ClockInOut() {
  ...
  const checkStatus = async () => {
    try {
      const res = await fetch(`https://backend-xs9b.onrender.com/get-attendance/${user.uid}`);
  ...
  const handleClockIn = async () => {
    try {
      const res = await fetch("https://backend-xs9b.onrender.com/clock-in", {
        method: "POST",
  ...
  const handleClockOut = async () => {
    ...
    try {
      const res = await fetch("https://backend-xs9b.onrender.com/clock-out", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
